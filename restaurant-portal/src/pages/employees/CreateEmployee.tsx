      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
        <Card className="p-0 border border-border/50 shadow-soft bg-white overflow-hidden">
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            {/* Action Buttons */}
            <div className="p-6 border-t border-border bg-gray-50 flex items-center justify-end gap-4 rounded-b-xl sticky bottom-0 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
              <Link to="/employees">
              ...
              <Button type="submit" disabled={isSubmitting} className="gap-2 px-8 shadow-sm">
