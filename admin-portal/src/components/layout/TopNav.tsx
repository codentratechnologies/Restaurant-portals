    ...
    <header className={cn(
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-5">
          ...
          {/* Profile Link */}
          <Link to="/settings/profile" className="flex items-center hover:bg-gray-50 p-1 sm:p-1.5 rounded-full transition-colors border border-transparent hover:border-border group shrink-0">
            <img
