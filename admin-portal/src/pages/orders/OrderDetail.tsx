...
export default function OrderDetail() {
 ...
 <span key={idx} className="text-[10px] font-bold text-brand-orange-600 bg-brand-orange-50 px-2 py-0.5 rounded-md border border-brand-orange-100 uppercase tracking-wide">
