          ...
          <div className="flex gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-[#1a1f36] tracking-tight mb-1">
                Deactivate Branch — {branchName}?
              </h2>
              <p className="text-xs font-semibold text-[#8896AB]">
                You are about to deactivate this branch. Please review the details below.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-4 p-5 bg-[#FFF3E8]/50 border border-[#FF6B00]/20 rounded-xl mb-8">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-[#1a1f36] leading-relaxed">
              Deactivating this branch will immediately stop<br/>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs font-semibold text-[#1a1f36]">
                Customers won't be able to place new orders at this branch.
              </span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs font-semibold text-[#1a1f36]">
                Ongoing orders will continue to be processed.
              </span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs font-semibold text-[#1a1f36]">
                This branch will be marked as inactive and hidden from customers.
              </span>
            </div>
          </div>
        </div>
