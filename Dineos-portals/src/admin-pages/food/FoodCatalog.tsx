        ...
        <div className="space-y-6 pb-10">
            ...
            >
                <Card className="p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
                    <div className="w-14 h-14 rounded-full bg-[#FFF3E8] border border-[#FFD0B5]/50 flex items-center justify-center shrink-0">
                        <LayoutTemplate className="w-6 h-6 text-[#FF6B00]" />
                    </div>
                    <div>
                        <p className="text-sm font-bold text-[#1a1f36] mb-0.5">Total Items</p>
                        <h3 className="text-[22px] font-black text-[#1a1f36] leading-none">{totalItems}</h3>
                        <p className="text-xs font-semibold text-[#8896AB] mt-1.5">Across all categories</p>
                    </div>
                </Card>
                <Card className="p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
                    <div className="w-14 h-14 rounded-full bg-[#E5F5ED] border border-[#00A254]/20 flex items-center justify-center shrink-0">
                        <CheckCircle className="w-6 h-6 text-[#00A254]" />
                    </div>
                    <div>
                        <p className="text-sm font-bold text-[#1a1f36] mb-0.5">Active Items</p>
                        <h3 className="text-[22px] font-black text-[#1a1f36] leading-none">{activeItems}</h3>
                        <p className="text-xs font-semibold text-[#8896AB] mt-1.5">{activePercentage}% of total</p>
                    </div>
                </Card>
                <Card className="p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
                    <div className="w-14 h-14 rounded-full bg-[#FFF0F2] border border-[#FF3B5C]/20 flex items-center justify-center shrink-0">
                        <PauseCircle className="w-6 h-6 text-[#FF3B5C]" />
                    </div>
                    <div>
                        <p className="text-sm font-bold text-[#1a1f36] mb-0.5">Inactive Items</p>
                        <h3 className="text-[22px] font-black text-[#1a1f36] leading-none">{inactiveItems}</h3>
                        <p className="text-xs font-semibold text-[#8896AB] mt-1.5">{inactivePercentage}% of total</p>
                    </div>
                </Card>
                <Card className="p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
                    <div className="w-14 h-14 rounded-full bg-[#F3E8FF] border border-[#A855F7]/20 flex items-center justify-center shrink-0">
                        <Tag className="w-6 h-6 text-[#A855F7]" />
                    </div>
                    <div>
                        <p className="text-sm font-bold text-[#1a1f36] mb-0.5">Categories</p>
                        <h3 className="text-[22px] font-black text-[#1a1f36] leading-none">{uniqueCategories}</h3>
                        <p className="text-xs font-semibold text-[#8896AB] mt-1.5">Food categories</p>
                    </div>
                </Card>
            </motion.div>
