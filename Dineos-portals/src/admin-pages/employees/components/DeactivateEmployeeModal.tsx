...
export default function DeactivateEmployeeModal({ isOpen, onClose, onConfirm, employeeName }: Props) {
 ...
 return (
 <Modal isOpen={isOpen} onClose={onClose} title={`Deactivate Employee — ${employeeName}?`} maxWidth="md">
 <div className="p-6">
 ...
 Deactivating this employee will immediately revoke all access to active ROMS portals and sessions.
 </p>
 </div>
 </div>
